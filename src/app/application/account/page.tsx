...
const Account: React.FC = () => {
  return (
    ...
    <img className="mx-auto rounded-full h-36 w-36" src="https://i.imgflip.com/4l0t4u.png" alt="author avatar"></img>
            ...
            <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                ...
                <div className="flex justify-center mt-5 space-x-5"><a href="#" target="_blank" rel="noopener noreferrer"
                        className="inline-block text-gray-400"><span className="sr-only">Twitter</span><svg
                            ...
                            className="w-6 h-6 text-cyan-300 hover:text-gray-100" height="1em" width="1em"
                        ...
                        className="inline-block text-gray-400"><span className="sr-only">GitHub</span><svg stroke="currentColor"
                            ...
                            className="w-6 h-6 text-gray-300 hover:text-gray-100" height="1em" width="1em"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a href="#" target="_blank" rel="noopener noreferrer"
                        className="inline-block text-gray-400"><span className="sr-only">Linkedin</span><svg
                            ...
                            className="w-6 h-6 text-cyan-400 hover:text-gray-100" height="1em" width="1em"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div className="w-[44vw] px-6 py-6  text-center bg-zinc-200 rounded-lg lg:mt-0 xl:px-10 flex flex-col border border-zinc-400">
          ...
          <div className="flex items-center justify-between mb-4 ">
            <div className="flex-col">
              ...
              <span className="ml-2">E12345</span>
            </div>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4">
              Edit
            </button>
