...
<div className="h-[18vh] w-[20vw] rounded-xl border border-white bg-zinc-200  mr-7 ">Mobile Users</div>
<div className="h-[1w8vh] w-[20vw] rounded-xl border border-white bg-zinc-200 mr-5">Mobile Requests</div>
<div className="h-[18vh] w-[20vw] rounded-xl border border-white bg-zinc-200 ">Acitivity Logs</div>
    </div>
<div className="content-center flex m-2">
<div className="h-[18vh] w-[42vw] rounded-xl border border-white bg-zinc-200 mr-5 ">Reminders</div>
    </div>
<div className="content-center flex m-2">
...
<div className="h-[40vh] w-[20vw] rounded-xl border border-white bg-zinc-200 mr-5 ">Chats</div>
    </div>
    </div>
    </div>
  );
