    ...
    <div className="flex flex-col justify-start place-items-center w-full h-full gap-7">
      <div className="space-y-2 w-[90%]   h-fit rounded-2xl">
        <div className="w-full px-6 py-6 mx-auto drop-zone loopple-min-height-78vh text-slate-500">
          <div
            className="relative flex flex-col flex-auto min-w-0 p-4 overflow-hidden break-words border-0 shadow-blur rounded-2xl bg-white bg-clip-border draggable"
            draggable="true"
          >
                  ...
                  <div className="p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
                    <div className="flex flex-wrap -mx-3">
                      ...
                      <div className="w-full max-w-full px-3 text-right shrink-0 md:w-4/12 md:flex-none">
                        ...
                        <div
                          data-target="tooltip"
                          className="px-2 py-1 text-center text-white bg-black rounded-lg text-sm hidden absolute inset-auto top-0 left-0 -translate-x-915 -translate-y-642"
                          role="tooltip"
                          data-popper-placement="top"
                        >
                          Edit Profile
                          <div
                            className="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-[''] translate-x-0 translate-y-0"
                            data-popper-arrow=""
                          ></div>
                        </div>
                      </div>
